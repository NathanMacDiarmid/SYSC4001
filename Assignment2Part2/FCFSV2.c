...
int main(void) {
    ...
    char testFileName[256]; // Assuming a reasonable maximum length for file paths
    char outputFileName[256];
    char outputFileMEMORY[256];
    
    printf("Enter the path to the test file: ");
    scanf("%255s", testFileName);

    printf("Enter the path to the output file: ");
    scanf("%255s", outputFileName);

    printf("Enter the path to the MEMORY output file: ");
    scanf("%255s", outputFileMEMORY);
